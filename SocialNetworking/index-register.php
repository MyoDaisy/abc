            ...
            <div class="reg-form-container"> 
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="register">
                  ...
                  <!--Register Form-->
                  <form name="registration_form" id='registration_form' method="POST" action="register.php" class="form-inline">
                    <div class="row">
                    ...
                    <input type="submit" name="submit-register" class="btn btn-primary" value="Register Now">
                ...
                <div class="tab-pane" id="login">
                  ...
                  <!--Login Form-->
                  <form name="Login_form" id='Login_form' method="POST" action="handlinglogin.php">
                     <div class="row">
                      <div class="form-group col-xs-12">
                        <label for="email" class="sr-only">Email</label>
                        <input id="email" class="form-control input-group-lg" type="text" name="email" title="Enter Email" placeholder="Your Email"/>
