...
<html lang="en">
    ...
    <script type="text/javascript">
		function checkform(){
			...
			{
				alert('Import your username')
				document.form.email.focus();
				return false;
			}
			if(document.form.password.value=="")
			{
				alert('Import your password')
		        ...
		        ================================================= -->
       			<div class="sign-up-form">
					...
					<div class="form-wrapper">
						...
						<form action="handlinglogin.php" method="POST" name="form-login">
							...
							<input type="submit" onclick="return checkform();" class="btn-secondary" value="Login" name="login">
						</form>
						
					</div>
					<a href="index-register.php">You don't have account?</a>
    ...
    ================================================= -->
		<section id="app-download">
			<div class="container wrapper">
				...
				<img src="images/marketing.jpg" alt="missfortune" class="img-responsive" />
			</div>
		</section>
